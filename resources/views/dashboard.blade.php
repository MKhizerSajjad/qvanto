                    ...
                    <ul id="iq-sidebar-toggle" class="iq-menu">
                        ...
                        <li class=" ">
                            <a href="#app" class="collapsed" data-toggle="collapse" aria-expanded="false">
                                <i class="las la-mobile iq-arrow-left"></i><span>App Design</span>
                                <i class="las la-angle-right iq-arrow-right arrow-active"></i>
                                <i class="las la-angle-down iq-arrow-right arrow-hover"></i>
                            </a>
                            <ul id="app" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                <li class=" ">
                                    ...
                                    <ul id="user" class="iq-submenu collapse" data-parent="#app">
                                        <li class=" ">
                                            <a
                                                href="https://templates.iqonic.design/instadash/html/app/user-profile.html">
                                                <i class="las la-id-card"></i><span>User Profile</span>
                                            </a>
                                        </li>
                                        <li class=" ">
                                            <a href="https://templates.iqonic.design/instadash/html/app/user-add.html">
                                                <i class="las la-user-plus"></i><span>User Add</span>
                                            </a>
                                        </li>
                                        <li class=" ">
                                            <a href="https://templates.iqonic.design/instadash/html/app/user-list.html">
                                ...
                                <li class=" ">
                                    <a href="#email" class="collapsed" data-toggle="collapse" aria-expanded="false">
                                        <i class="las la-at"></i><span>Mail</span>
                                        <i class="las la-angle-right iq-arrow-right arrow-active"></i>
                                        <i class="las la-angle-down iq-arrow-right arrow-hover"></i>
                                    </a>
                                    <ul id="email" class="iq-submenu collapse" data-parent="#app">
                                        <li class=" ">
                                            <a href="https://templates.iqonic.design/instadash/html/app/email.html">
                                                <i class="las la-inbox"></i><span>Inbox</span>
                                            </a>
                                        </li>
                                        <li class=" ">
                                            <a
                                                href="https://templates.iqonic.design/instadash/html/app/email-compose.html">
                                ...
                                <li class=" ">
                                    <a href="https://templates.iqonic.design/instadash/html/app/chat.html">
                                        <i class="lab la-rocketchat"></i><span>Chat</span>
                                    </a>
                                </li>
                                <li class=" ">
                                    <a href="https://templates.iqonic.design/instadash/html/app/todo.html">
                                        <i class="las la-check-double"></i><span>Todo</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class=" ">
                            ...
                            <ul id="gallery" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                ...
                                <li class=" ">
                                    <a href="gallery-masonry-desc.html">
                                        <i class="las la-stream"></i><span>Masonry with Desc</span>
                                    </a>
                                </li>
                                <li class=" ">
                                    <a href="gallery-hover-effect.html">
                        ...
                        <li class=" ">
                            ...
                            <ul id="pages" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                ...
                                <li class=" ">
                                    <a href="#timeline" class="collapsed" data-toggle="collapse"
                                        aria-expanded="false">
                            ...
                            <ul class="navbar-nav ml-auto navbar-list align-items-center">
                                ...
                                <li class="caption-content">
                                    <a href="#" class="iq-user-toggle">
                                        <img src="../assets/images/user/1.jpg" class="img-fluid rounded"
                                            alt="user">
                                    </a>
                                                    ...
                                                    <div class="profile-header">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6  col-md-6 col-6">
                                                                <div class="profile-details text-center">
                                                                    <a href="https://templates.iqonic.design/instadash/html/app/user-profile-edit.html"
                                                            ...
                                                            <div class="col-lg-6 col-md-6  col-6 pr-0">
                                                                <div class="profile-details text-center">
                                                                    <a href="https://templates.iqonic.design/instadash/html/app/user-account-setting.html"
                                                            ...
                                                            <div class="col-lg-6 col-md-6  col-6">
                                                                <div class="profile-details text-center">
                                                                    <a href="https://templates.iqonic.design/instadash/html/app/user-privacy-setting.html"
