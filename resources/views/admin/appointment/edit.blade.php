                ...
                <div class="col-xl-12 col-lg-12" bis_skin_checked="1">
                    ...
                    <div class="card-header d-flex justify-content-between" bis_skin_checked="1">
                        <div class="header-title" bis_skin_checked="1">
                            <h4 class="card-title">Update Booked Appointment</h4>
                        </div>
                    </div>
                            ...
                            <form method="POST" action="{{ route('appointment.update', $appointment->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row" bis_skin_checked="1">
                                    ...
                                    <div class="form-group col-md-12" bis_skin_checked="1">
                                        ...
                                        <textarea type="text" class="form-control" id="note" name="note" placeholder="Note">{{ old('note', $appointment->note) }}</textarea>
                                    </div>
                                </div>
