                ...
                <div class="col-xl-12 col-lg-12" bis_skin_checked="1">
                    ...
                    <div class="card-header d-flex justify-content-between" bis_skin_checked="1">
                        <div class="header-title" bis_skin_checked="1">
                            <h4 class="card-title">Update Vednor</h4>
                        </div>
                    </div>
                            ...
                            <form method="POST" action="{{ route('vendor.update', $vendor->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row" bis_skin_checked="1">
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        ...
                                        <input type="text" class="form-control" id="first_name" name="first_name" placeholder="First Name" value="{{ old('first_name', $vendor->first_name) }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        <label for="last_name">Last Name <span class="text text-danger">*</span></label>
                                        <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Last Name" value="{{ old('last_name', $vendor->last_name) }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        <label for="picture">Picture</label>
                                        <input type="file" id="picture" name="picture" placeholder="Picture" value="{{ old('picture', $vendor->picture) }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                    ...
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        ...
                                        <input type="tel" class="form-control" id="mobile_number" name="mobile_number" placeholder="Mobile Number" value="{{ old('mobile_number', $vendor->mobile_number) }}">
                                    </div>
