                ...
                <div class="col-xl-12 col-lg-12" bis_skin_checked="1">
                    ...
                    <div class="card-header d-flex justify-content-between" bis_skin_checked="1">
                        <div class="header-title" bis_skin_checked="1">
                            <h4 class="card-title">Add New Associato</h4>
                        </div>
                    </div>
                            ...
                            <form method="POST" action="{{ route('vendor.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="row" bis_skin_checked="1">
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        ...
                                        <input type="text" class="form-control" id="first_name" name="first_name" placeholder="Nome" value="{{ old('first_name') }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        <label for="last_name">Cognome <span class="text text-danger">*</span></label>
                                        <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Cognome" value="{{ old('last_name') }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        <label for="picture">Immagine</label>
                                        <input type="file" id="picture" name="picture" placeholder="Immagine" value="{{ old('picture') }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                    ...
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        ...
                                        <input type="tel" class="form-control" id="mobile_number" name="mobile_number" placeholder="Cellulare" value="{{ old('mobile_number') }}">
                                    </div>
                                    {{-- <div class="form-group col-md-4" bis_skin_checked="1">
