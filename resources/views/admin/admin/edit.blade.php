                            ...
                            <form method="POST" action="{{ route('admins.update', $admin->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row" bis_skin_checked="1">
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        ...
                                        <input type="text" class="form-control" id="first_name" name="first_name" placeholder="First Name" value="{{ old('first_name', $admin->first_name) }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        <label for="last_name">Last Name <span class="text text-danger">*</span></label>
                                        <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Last Name" value="{{ old('last_name', $admin->last_name) }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        <label for="picture">Picture</label>
                                        <input type="file" id="picture" name="picture" placeholder="Picture" value="{{ old('picture', $admin->picture) }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                    ...
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        ...
                                        <input type="tel" class="form-control" id="mobile_number" name="mobile_number" placeholder="Mobile Number" value="{{ old('mobile_number', $admin->mobile_number) }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        <label for="dob">Date of Birth</label>
                                        <input type="date" class="form-control" id="dob" name="dob" placeholder="Date Of Birth" value="{{ old('dob',  $admin->dob) }}">
                                    </div>
                                    {{-- <div class="form-group col-md-4" bis_skin_checked="1">
                                        <label for="nic">NIC <span class="text text-danger">*</span></label>
                                        <input type="text" class="form-control" id="nic" name="nic" placeholder="NIC" value="{{ old('nic', $admin->nic) }}">
                                    </div> --}}
                                    {{-- <div class="form-group col-md-4" bis_skin_checked="1">
                                        <label for="basic_salary">Basic Salary <span class="text text-danger">*</span></label>
                                        <input type="number" class="form-control" id="basic_salary" name="basic_salary" placeholder="Basic Salary" value="{{ old('basic_salary', $admin->basic_salary) }}">
                                    </div> --}}
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        ...
                                        <div class="dropdown" bis_skin_checked="1">
                                            <select class="form-control" id="designation" name="designation">
                                                ...
                                                @foreach (getDesignation() as $key => $label)
                                                    @php $key = ++$key; @endphp
                                                    <option {{ (old('designation', $admin->designation) == $key) ? 'selected="selected"' : '' }} value="{{ $key }}">{{ $label }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        ...
                                        <input type="text" class="form-control" id="zipcode" name="zipcode" placeholder="Zip Code" value="{{ old('zipcode', $admin->zipcode) }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        ...
                                        <div class="dropdown" bis_skin_checked="1">
                                            <select class="form-control" id="status" name="status">
                                                ...
                                                @foreach (getGeneralStatus() as $statusKey => $statusLabel)
                                                    ...
                                                    <option {{ (old('status', $admin->status) == $key) ? 'selected="selected"' : '' }} value="{{ $key }}">{{ $statusLabel }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-12" bis_skin_checked="1">
                                        ...
                                        <input type="text" class="form-control" id="address" name="address" placeholder="Address" value="{{ old('address', $admin->address) }}">
                                    </div>
                                </div>
                                <hr>
