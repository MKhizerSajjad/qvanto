                                        ...
                                        <tbody>
                                            @foreach ($data as $key => $customer)
                                                <tr>
                                                    <td>{{++$key}}</td>
                                                    <td>
                                                        <img src="{{ asset('images/customers/'.$customer->picture) }}" onerror="this.onerror=null;this.src='{{ asset('admin/images/user/user-dummy-img.png') }}';" alt="{{ $customer->first_name }}"  class="rounded avatar-40 img-fluid" >
                                                    </td>
                                                    <td>{{$customer->first_name}} {{$customer->last_name}}</td>
                                                    <td>{{$customer->email}}</td>
                                                    <td>{{$customer->mobile_number}}</td>
                                                    <td>{!! getGeneralStatus($customer->status, 'badge') !!}</td>
                                                    <td>
