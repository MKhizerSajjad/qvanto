                            ...
                            <form method="POST" action="{{ route('examination.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="row" bis_skin_checked="1">
                                    ...
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        ...
                                        <div class="dropdown" bis_skin_checked="1">
                                            <select class="form-control" id="status" name="status">
                                                ...
                                                @foreach (getExaminationStatus() as $key => $label)
                                                    @php $key = ++$key; @endphp
                                            ...
                                            <div class="dropdown" bis_skin_checked="1">
                                                <select class="form-control" id="counselor" name="counselor">
                                                    ...
                                                    @foreach ($counselors as $key => $counselor)
                                                        <option {{ (old('counselor') == $counselor->id) ? 'selected="selected"' : '' }} value="{{ $counselor->id }}">{{ $counselor->first_name }} {{ $counselor->last_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="dropdown" bis_skin_checked="1">
                                                <select class="form-control" id="examinar" name="examinar">
                                                    ...
                                                    @foreach ($employees as $key => $employee)
                                                        <option {{ (old('examinar') == $employee->id) ? 'selected="selected"' : '' }} value="{{ $employee->id }}">{{ $employee->first_name }} {{ $employee->last_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="dropdown" bis_skin_checked="1">
                                                <select class="form-control" id="client" name="client">
                                                    ...
                                                    @foreach ($customers as $key => $customer)
                                                        <option {{ (old('client') == $customer->id) ? 'selected="selected"' : '' }} value="{{ $customer->id }}">{{ $customer->first_name }} {{ $customer->last_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="dropdown" bis_skin_checked="1">
                                            <select class="form-control" id="language" name="language">
                                                ...
                                                @foreach (getLanguages() as $key => $label)
                                                    @php $key = ++$key; @endphp
                                                    <option {{ (old('language') == $key) ? 'selected="selected"' : '' }} value="{{ $key }}">{{ $label }}</option>
                                                @endforeach
                                            </select>
                                            <input type="text" class="form-control" id="other_language" name="other_language" placeholder="Language" value="{{ old('other_language') }}">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        ...
                                        <div class="dropdown" bis_skin_checked="1">
                                            <select class="form-control" id="autism" name="autism">
                                                ...
                                                @foreach (getBoolStatus() as $key => $label)
                                                    @php $key = ++$key; @endphp
                                                    <option {{ (old('autism') == $key) ? 'selected="selected"' : '' }} value="{{ $key }}">{{ $label }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        ...
                                        <div class="dropdown" bis_skin_checked="1">
                                            <select class="form-control" id="intellectual_disability" name="intellectual_disability">
                                                ...
                                                @foreach (getBoolStatus() as $key => $label)
                                                    @php $key = ++$key; @endphp
                                                    <option {{ (old('intellectual_disability') == $key) ? 'selected="selected"' : '' }} value="{{ $key }}">{{ $label }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        ...
                                        <input type="text" class="form-control" id="authorization" name="authorization" placeholder="Authorization" value="{{ old('authorization') }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        <label for="disability">Disability <span class="text text-danger">*</span></label>
                                        <input type="text" class="form-control" id="disability" name="disability" placeholder="Disability" value="{{ old('disability') }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        <label for="prior_diagnoses">Prior Diagnoses <span class="text text-danger">*</span></label>
                                        <input type="text" class="form-control" id="prior_diagnoses" name="prior_diagnoses" placeholder="Prior Diagnoses" value="{{ old('prior_diagnoses') }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        <label for="medications">Medications <span class="text text-danger">*</span></label>
                                        <input type="text" class="form-control" id="medications" name="medications" placeholder="Medications" value="{{ old('medications') }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        <label for="vocational_objective">Vocational Objective <span class="text text-danger">*</span></label>
                                        <input type="text" class="form-control" id="vocational_objective" name="vocational_objective" placeholder="Vocational Objective" value="{{ old('vocational_objective') }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        <label for="payer">Payer <span class="text text-danger">*</span></label>
                                        <input type="text" class="form-control" id="payer" name="payer" placeholder="Payer" value="{{ old('payer') }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        <label for="emergency_name">Emergency Name <span class="text text-danger">*</span></label>
                                        <input type="text" class="form-control" id="emergency_name" name="emergency_name" placeholder="Emergency Name" value="{{ old('emergency_name') }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        <label for="emergency_phone">Emergency Phone <span class="text text-danger">*</span></label>
                                        <input type="text" class="form-control" id="emergency_phone" name="emergency_phone" placeholder="Emergency Phone" value="{{ old('emergency_phone') }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        ...
                                        <div class="dropdown" bis_skin_checked="1">
                                            <select class="form-control" id="family_member_relation" name="family_member_relation">
                                                ...
                                                @foreach (getBoolStatus() as $key => $label)
                                                    @php $key = ++$key; @endphp
                                                    <option {{ (old('family_member_relation') == $key) ? 'selected="selected"' : '' }} value="{{ $key }}">{{ $label }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        ...
                                        <input type="text" class="form-control" id="family_member_name" name="family_member_name" placeholder="Family Member Name" value="{{ old('family_member_name') }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        <label for="family_member_phone">Family Member Phone <span class="text text-danger">*</span></label>
                                        <input type="text" class="form-control" id="family_member_phone" name="family_member_phone" placeholder="Family Member Phone" value="{{ old('family_member_phone') }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        <label for="family_member_email">Family Member Email <span class="text text-danger">*</span></label>
                                        <input type="text" class="form-control" id="family_member_email" name="family_member_email" placeholder="Family Member Email" value="{{ old('family_member_email') }}">
                                    </div>
