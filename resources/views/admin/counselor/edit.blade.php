                ...
                <div class="col-xl-12 col-lg-12" bis_skin_checked="1">
                    ...
                    <div class="card-header d-flex justify-content-between" bis_skin_checked="1">
                        <div class="header-title" bis_skin_checked="1">
                            <h4 class="card-title">Update Counselor</h4>
                        </div>
                    </div>
                    <div class="card-body" bis_skin_checked="1">
                        ...
                        <div class="new-user-info" bis_skin_checked="1">
                            <form method="POST" action="{{ route('counselor.update', $counselor->id) }}" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
                                <div class="row" bis_skin_checked="1">
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        ...
                                        <input type="text" class="form-control" id="first_name" name="first_name" placeholder="First Name" value="{{ old('first_name', $counselor->first_name) }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        <label for="last_name">Last Name <span class="text text-danger">*</span></label>
                                        <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Last Name" value="{{ old('last_name', $counselor->last_name) }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        <label for="picture">Picture</label>
                                        <input type="file" id="picture" name="picture" placeholder="Picture" value="{{ old('picture', $counselor->picture) }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        <label for="email">Email <span class="text text-danger">*</span></label>
                                        <input type="email" class="form-control" id="email" name="email" placeholder="Email" value="{{ old('email', $counselor->email) }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                        <label for="mobile_number">Office Number <span class="text text-danger">*</span></label>
                                        <input type="tel" class="form-control" id="mobile_number" name="mobile_number" placeholder="Office Number" value="{{ old('mobile_number', $counselor->mobile_number) }}">
                                    </div>
                                    <div class="form-group col-md-4" bis_skin_checked="1">
                                    ...
                                    {{-- <div class="form-group col-md-4" bis_skin_checked="1">
                                        ...
                                        <input type="text" class="form-control" id="nic" name="nic" placeholder="NIC" value="{{ old('nic', $counselor->nic) }}">
                                    </div> --}}
                                    <div class="form-group col-md-6" bis_skin_checked="1">
                                        <label for="zipcode">Zip Code</label>
                                        <input type="text" class="form-control" id="zipcode" name="zipcode" placeholder="Zip Code" value="{{ old('zipcode', $counselor->zipcode) }}">
                                    </div>
                                    <div class="form-group col-md-6" bis_skin_checked="1">
                                        ...
                                        <div class="dropdown" bis_skin_checked="1">
                                            <select class="form-control" id="status" name="status">
                                                ...
                                                @foreach (getGeneralStatus() as $statusKey => $statusLabel)
                                                    ...
                                                    <option {{ (old('status', $counselor->status) == $key) ? 'selected="selected"' : '' }} value="{{ $key }}">{{ $statusLabel }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-12" bis_skin_checked="1">
                                        ...
                                        <input type="text" class="form-control" id="address" name="address" placeholder="Address" value="{{ old('address', $counselor->address) }}">
                                    </div>
                                </div>
                                <hr>
