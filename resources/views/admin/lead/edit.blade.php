                            ...
                            <form method="POST" action="{{ route('lead.update', $lead->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row" bis_skin_checked="1">
                                    ...
                                    <div class="form-group col-md-6" bis_skin_checked="1">
                                        ...
                                        <input type="text" class="form-control" id="first_name" name="first_name" placeholder="First Name" value="{{ old('first_name', $lead->first_name) }}">
                                    </div>
                                    <div class="form-group col-md-6" bis_skin_checked="1">
                                        <label for="last_name">Last Name <span class="text text-danger">*</span></label>
                                        <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Last Name" value="{{ old('last_name', $lead->last_name) }}">
                                    </div>
                                    <div class="form-group col-md-6" bis_skin_checked="1">
                                    ...
                                    <div class="form-group col-md-6" bis_skin_checked="1">
                                        ...
                                        <input type="tel" class="form-control" id="mobile_number" name="mobile_number" placeholder="Mobile Number" value="{{ old('mobile_number', $lead->mobile_number) }}">
                                    </div>
